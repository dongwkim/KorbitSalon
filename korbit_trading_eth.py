...
if __name__ == "__main__":
    ...
    while True:
        ...
        if ticker['timestamp'] > prev_ticker['timestamp'] or ticker['bid'] != prev_ticker['bid'] or ticker['ask'] != prev_ticker['ask']:
            ...
            print( "{} | Price: p:{:,d}/b:{:,d}/a:{:,d}/l:{:,d} | Buy/Sell/Vol: {}/{}/{} |  Delta: {:6.0f}/{:6.0f}/{:6.0f} Avg: {:6.0f}/{:6.0f} |  lat: {:4d} ms| bidding ({}) | balance:{}  " \
            ...
            elif not trading and myalgo.basic(95) and myalgo.slump(10, 0.3, 3, 1.3 , -9999 ):
            ...
            elif not trading and myalgo.basic(95) and myalgo.slump(7, 0.1, 2.0, 1.0 , -9999 ):
            ...
            elif not trading and myalgo.basic(97) and myalgo.slump(7, 0.2, 1.6, -2.5 , 100 ):
            ...
            elif not trading and last < high * limit and   myalgo.rise(0.1, 1, 0.8, 1.0, 3 ):
                print("Hit : Rise")
                bidding = False
                benefit = 0.012
                money = 100000
