...
if __name__ == "__main__":
    ...
    start_time = xrpm.getEpochTime('2018-02-04 00:00:00')
    end_time = xrpm.getEpochTime('2018-02-05 23:00:00')
    myTimestamp.sort()
    if debug_data:
        pass
    ...
    try:
        ...
        print("\033[93mERROR | Start / End Time is not in redis data\033[0m")
        raise
    ...
    for ptime in timestampBucker[start_pos:end_pos:3]:
    ...
    #while start_time <= end_time:
        ...
        for mystat in mystats:
            ...
            if not xrpm.bidding and not xrpm.trading and myalgo.basic(95) and  myalgo.slump(15, 0.9, 5, 2.0, -9999):
            ...
            elif not xrpm.bidding and not xrpm.trading and myalgo.basic(95) and  myalgo.slump(10, 0.9, 4, 1.3 , -9999 ):
            ...
            elif not xrpm.bidding and myalgo.basic(95) and myalgo.slump(10, 0.9, 3, 1.2 , -9999 ):
                print("{:20s} | \033[95mHit {} Algorithm\033[0m | price:{} delta:{}/{}/{} avg:{:4.0f}/{:4.0f}"\
            ...
            ## Regresssion
              ...
              and myalgo.reg(3,-2) and myalgo.basic(97) :
                print("{:20s} | \033[95mHit {} Algorithm\033[0m | price:{} delta:{}/{}/{} avg:{:4.0f}/{:4.0f}"\
