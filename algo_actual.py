...
if __name__ == "__main__":
    ...
    xrpm = xrpmgrsimul('ACTUAL', 'cryptosalon.iptime.org', 16379,'RlawjddmsrotoRl#12', 'xrp')
    ...
    while True:
        ...
        if int(mystat['timestamp']) > int(prev_mystat['timestamp']) or mystat['bid'] != prev_mystat['bid'] or mystat['ask'] != prev_mystat['ask']:
            ...
            if debug_time:
                ...
                print("{} | Price: p:{}/b:{}/a:{}/l:{} | Delta: {:3d}/{:3d}/{:3d} | Avg: {:4.0f}/{:4.0f} | lat: {:3.1f} ms".format(kb.getStrTime(int(ptime)),mystat['last'], mystat['bid'], mystat['ask'], mystat['high'], mystat['tx_60min_delta'], mystat['tx_10min_delta'], mystat['tx_1min_delta'], mystat['tx_60min_avg'], mystat['tx_10min_avg'], loop_time))
            if mystat == 0:
                continue
